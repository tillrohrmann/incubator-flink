...
public class TaskExecutorRecoveryTest extends TestLogger {
    ...
    @Test
    public void testRecoveredTaskExecutorWillRestoreAllocationState() throws Exception {
        ...
        final ArrayBlockingQueue<TaskExecutorSlotReport> queue =
                new ArrayBlockingQueue<TaskExecutorSlotReport>(2);
        ...
        final TestingRpcService rpcService = rpcServiceResource.getTestingRpcService();
        ...
        final TaskExecutor taskExecutor =
                TaskExecutorBuilder.newBuilder(rpcService, highAvailabilityServices)
