...
public class TaskExecutorBuilder {
    ...
    @Nullable private BlobCacheService blobCacheService = null;
    ...
    private TaskExecutorBuilder(RpcService rpcService, HighAvailabilityServices haServices) {
        ...
        if (taskManagerConfiguration == null) {
            resolvedTaskManagerConfiguration =
                    TaskManagerConfiguration.fromConfiguration(
                            configuration, taskExecutorResourceSpec, rpcService.getAddress());
        } else {
