...
public class JobMasterServiceLeadershipRunnerTest extends TestLogger {
    ...
    public void testConcurrentLeadershipOperationsBlockingClose() throws Exception {
        ...
        final Queue<TestingJobMasterService> testingJobMasterServices = new ArrayDeque<>(2);
        testingJobMasterServices.add(
                new TestingJobMasterService("localhost", terminationFuture, null));
        testingJobMasterServices.add(new TestingJobMasterService());
    ...
    @Nonnull
    private JobMasterServiceLeadershipRunner createJobManagerLeadershipRunner(
    ...
    @Nonnull
    private JobMasterServiceLeadershipRunner createJobManagerLeadershipRunner() throws Exception {
        return createJobManagerLeadershipRunner(
                defaultJobMasterServiceProcessFactory,
    ...
    @Nonnull
    JobMasterServiceLeadershipRunner createJobManagerLeadershipRunner(
    ...
    public static class BlockingJobMasterServiceProcessFactory
        ...
        public ArchivedExecutionGraph createArchivedExecutionGraph(
            ...
            return ArchivedExecutionGraph.createFromInitializingJob(
                    jobGraph.getJobID(), jobGraph.getName(), jobStatus, cause, 1337L);
        }
    }
}
