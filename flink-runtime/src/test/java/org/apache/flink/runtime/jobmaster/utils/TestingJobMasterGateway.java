...
public class TestingJobMasterGateway implements JobMasterGateway {
	...
	public TestingJobMasterGateway(
			...
			@Nonnull BiFunction<OperatorID, SerializedValue<CoordinationRequest>, CompletableFuture<CoordinationResponse>> deliverCoordinationRequestFunction, Consumer<Collection<ResourceRequirement>> notifyNotEnoughResourcesConsumer) {
