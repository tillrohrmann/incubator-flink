...
public class TestingJobMasterServiceFactory implements JobMasterServiceFactory {
	...
	@Override
	public JobMasterService createJobMasterService(JobMasterId jobMasterId, JobGraph jobGraph, OnCompletionActions jobCompletionActions, ClassLoader userCodeClassloader) {
