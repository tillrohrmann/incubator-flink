...
public class TaskManagerSlot implements TaskManagerSlotInformation {
	...
	private static final PendingSlotRequest DUMMY_REQUEST = new PendingSlotRequest(new SlotRequest(new JobID(), DeclarativeSlotManager.DUMMY_ALLOCATION_ID, ResourceProfile.UNKNOWN, ""));
