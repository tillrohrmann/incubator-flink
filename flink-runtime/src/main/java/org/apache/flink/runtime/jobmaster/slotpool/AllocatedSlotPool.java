...
public interface AllocatedSlotPool {
	...
	/**
	 * Gets information about all currently free slots.
	 *
	...
	/**
	 * Gets information about all slots in this pool.
	 *
	...
	/**
	 * Allocates a free slot specified by the given allocationId.
	 *
	 * @param allocationId allocationId identifying the slot free slot to allocate
	 * @return the {@link AllocatedSlot} which has been allocated
	 * @throw IllegalStateException if there is no free slot with the given allocationId
	 */
	AllocatedSlot allocateFreeSlot(AllocationID allocationId);

	/**
	 * Releases allocated slot adding it back into the set of free slots.
	 *
	 * @param allocationId identifying the allocated slot to free
	 * @param currentTime currentTime when the slot has been released
	 * @return the freed {@link AllocatedSlot} if there was an allocated with the given allocationId;
	 * otherwise {@link Optional#empty()}.
	 */
	Optional<AllocatedSlot> releaseAllocatedSlot(AllocationID allocationId, long currentTime);
	 ...
	 * @throw IllegalStateException if the slot pool already contains a to be added slot
	 */
	...
	interface FreeSlotInfo {
		...
		/**
		 * Gets since when this slot is free.
		 *
