...
import static org.apache.flink.runtime.scheduler.declarative.scalingpolicy.ReactiveScalingPolicyOptions.MIN_PARALLELISM_INCREASE;
 ...
 */
public class ReactiveScalingPolicy implements ScalingPolicy {

    private final int minParallelismIncrease;

    public ReactiveScalingPolicy(Configuration configuration) {
