...
MVN_COMMON_OPTIONS="-nsu -Dflink.forkCount=1 -Dflink.forkCountTestPackage=1 -Dfast -B $MVN_LOGGING_OPTIONS"
MVN_COMPILE_OPTIONS="-DskipTests"
MVN_TEST_OPTIONS="$MVN_LOGGING_OPTIONS"

MVN_COMPILE="mvn $MVN_COMMON_OPTIONS $MVN_COMPILE_OPTIONS $PROFILE -Dcheckstyle.skip=true -pl flink-runtime -am install"
MVN_TEST="mvn $MVN_COMMON_OPTIONS $MVN_TEST_OPTIONS $PROFILE -pl flink-runtime -Dtest=LeaderChangeClusterComponentsTest -DfailIfNoTests=false -Dcheckstyle.skip=true test"
