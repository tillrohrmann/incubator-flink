 ...
 */
public class UserFunctionOperatorRescalingPolicyFactory implements OperatorRescalingPolicy.Factory {
	private static final long serialVersionUID = 6565527910656727465L;

	@Nonnull
	private final WithRescalingPolicy withRescalingPolicy;

	public UserFunctionOperatorRescalingPolicyFactory(@Nonnull WithRescalingPolicy withRescalingPolicy) {
		this.withRescalingPolicy = withRescalingPolicy;
	}
